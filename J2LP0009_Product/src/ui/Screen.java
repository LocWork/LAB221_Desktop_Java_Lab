...
public class Screen extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnNewC.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        ...
        btnUpdateC.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        ...
        jPanel1.add(btnUpdateC);

        btnDeleteC.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        ...
        tbl.setFont(new java.awt.Font("Tahoma", 0, 24)); // NOI18N
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(cbox, javax.swing.GroupLayout.Alignment.TRAILING, 0, 655, Short.MAX_VALUE)
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addComponent(pCatagory, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
...
//            if(c.checkTableExist(x) == true){
//                JOptionPane.showMessageDialog(this, "There is already a table with that name");
//                return false;
//            }
        } catch (Exception e) {
            e.printStackTrace();
        ...
        if(currentCategoryName != null && currentCategoryID != null){
            ...
            try {
                ...
                if(numberOfProduct > 0){
                    if(JOptionPane.showConfirmDialog(this,"There is "+numberOfProduct+" still exist\nContinue anyway ","Delete a catagory", JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION){
                    ...
                    if(JOptionPane.showConfirmDialog(this,"Are you sure","Delete a catagory", JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION){
                        ser.deletedCatagory(currentCategoryID);
                        loadCategoryData();
                        currentCategoryID = null;
                    }                    
    ...
    private void btnUpdateCActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateCActionPerformed
        if(currentCategoryID != null && currentCategoryName != null){
            if(JOptionPane.showConfirmDialog(this,"Are you sure","Rename a catagory", JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION){
...
//        btnDelete.setEnabled(true);
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        if(currentProduntID != null){            
            try {
                if(JOptionPane.showConfirmDialog(this, "Are you sure","Delete product",JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION){
                    resetProdutInput();
...
//                JOptionPane.showMessageDialog(this, "Null Input ERROR");
//                return false;
//            }             
...
//        cbox.setSelectedItem();
    ...
    public String capcha(){
        ...
        String alphaBee= "ABCDEFGHIJKLMNOPQRSTUVWSYZ";
        for(int i =0; i< 5; i++){
            int x = 1 + rand.nextInt(25);

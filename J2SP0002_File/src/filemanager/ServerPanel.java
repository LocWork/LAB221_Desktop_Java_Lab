...
public class ServerPanel extends javax.swing.JFrame {
    ...
    private void btnStartActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnStartActionPerformed
        try {
            staffSocket = new ServerSocket(programPort);
            theSocket = staffSocket.accept();
            try {
                DataInputStream dis = new DataInputStream(theSocket.getInputStream());
                if(dis.available() > 0){
                    txtArea.append("There is data");
                }
